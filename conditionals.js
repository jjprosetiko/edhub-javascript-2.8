...
const $1 = 10 >= 20;
console.log("Is 10 groter dan 20?", $1)
...
const $2 = 10 != 11;
console.log("Is 10 ongelijk aan 11?", $2)
...
const $3 = "zoet" == "sappig";
console.log("Zijn de woorden -zoet- en -sappig- hetzelfde?)", $3)
...
if (grade < 5.5) {
    console.log("Behaald resultaat: onvoldoende")
}

if ((grade >= 5.5 && grade <8)) {
    console.log("Behaald resultaat: voldoende")
}

if (grade > 8) {
    console.log("Behaald resultaat: Cum Laude!")
}
